...
namespace cpp
{
    ...
    double Dot::_x(){return x;}// get x
    double Dot::_y(){return y;}// get y
    ...
    double Line::_A(){return A;}
    double Line::_B(){return B;}
    double Line::_C(){return C;}
    double Line::angle_from_x()// angle between line and x axis
    {
        if (A == 0 && B == 0)
            return NAN;
    ...
    double Line::angle_from(Line s)// angle between line and another line
    {
        double A1 = A;
        double B1 = B;
        double A2 = s._A();
    ...
    int Line::is_separating_dots(Dot a, Dot b)//is line separating two dots from each other
    {
    ...
    Dot Line::is_crossing(Line s)//is line crossing another line
    {
        Dot t;
